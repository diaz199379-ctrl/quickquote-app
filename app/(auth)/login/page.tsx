      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-text-secondary mt-2">
            {t('auth.signInToAccount', { fallback: 'Sign in to your account' })}
          </p>
        </div>

        {/* Login Card */}
        <Card className="p-6">
          <h1 className="text-xl font-semibold text-text-primary mb-6">{t('auth.welcomeBack', { fallback: 'Welcome back' })}</h1>
          <LoginForm />
        </Card>
